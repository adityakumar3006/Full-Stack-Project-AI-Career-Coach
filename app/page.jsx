        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Four simple steps to get started with your career growth journey:
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <blockquote>
                        <p className="text-muted-foreground italic relative">
                          <span className="text-3xl text-primary absolute -top-6 -left-2">
                            &quot;
        ...
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-lg">
              Join thousands of professionals who trust Sensai for their career growth.
            </p>
            <Link href={"/dashboard"}>
              <Button
                size={"lg"}
