...
const DashboardView = ({ insights }) => {
    ...
    const OutllokIcon = getMarketOutlookInfo(insights.marketOutlook).icon;
    ...
    return (
        <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 '>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <OutllokIcon className={`h-4 w-4 ${OutlookColor}`} />
            ...
            <Card>
                ...
                <CardTitle className="text-sm font-medium">Salary ranges by Role </CardTitle>
                <CardDescription>
                    Displaying minimum, median and maximum salries (in thousands)
                </CardDescription>
            ...
            <div className='grid grid-cols-1 md:grids-cols-2 gap-4 '>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className='flex flex-wrap-gap-42'>
